...
public class SHIELDTerminal {
    ...
    // - Elimina acentos (e.g., "misión" -> "mision")
    // - Pone todo en minúsculas
    // - Elimina espacios, guiones y caracteres no alfabéticos
    // - Mapea variantes comunes a llaves estables (ej.: "enmision" y "mision")
    private static String keyOf(String s) {
        if (s == null) return ""; // Evita NPE; devuelve cadena vacía si es nulo
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Heroe> heroes = new ArrayList<>(); // Lista polimórfica de héroes
        ...
        do {
            ...
            System.out.println("2. Filtrar por estatus (escribe: Activo | Mision | Retirado)"); // Nota: "Mision" sin acento funciona
